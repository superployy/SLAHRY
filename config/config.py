...
# ============================================================
# SECRETS — set these as environment variables in Railway
...
SONGINFO_ERROR = "Error: Unsupported site or age restricted content."
...
HELP_DISCONNECT_SHORT = "Disconnect bot from voicechannel"
...
HELP_VOL_LONG = "Changes the volume of the AudioPlayer."
...
HELP_SONGINFO_LONG = "Shows details about the song currently being played."
...
HELP_YT_LONG = "$p [link/video title/keywords/playlist/soundcloud/spotify/bandcamp]"
...
HELP_LOOP_LONG = "Loops the currently playing song and locks the queue."
